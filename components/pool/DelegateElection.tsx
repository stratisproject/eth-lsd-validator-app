  ...
  return (
    <div>
      <div className="mt-[.48rem] flex items-center  flex-wrap gap-[.16rem]">
        <div className={classNames(robotoBold.className, "text-[.24rem] text-color-text1")}>Delegate Election</div>
        ...
        >
          <div className="text-color-text2 text-[.16rem]">StaFi Delegation Mechanism</div>

          <div className="flex items-center">
            <Icomoon icon="right" size=".1rem" color={darkMode ? "#ffffff80" : "#6C86AD"} />
          </div>
        </div>
      </div>
